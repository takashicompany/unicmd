			...
			if (args != null)
			{
				foreach (string arg in args)
				{
					...
					else
					{
						...
						Component component = go.AddComponent(arg);
						if (component == null)
						{
		...
		{ 
			if (args == null || args.Length == 0) 
			{
				return string.Format(
					...
					PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.iPhone)
				);
			...
			if (args.Length == 1)
			{
				...
				PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.iPhone,args[0]);
			}
			else
			{
				string definesAndroid = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android);
				string definesIOS = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.iPhone);
				...
				PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.iPhone,definesIOS);
			}
